...
const Addvenu: React.FC<EditProfileManagementProps> = ({
    ...
    // Add this to your existing component above `return`
    interface MenuItem {
        name: string;
        description: string;
        price: string;
                    ...
                    <div>
                        ...
                        {menuItems.map((item, index) => (
                            <div key={index} className="mb-4 pb-4">
                                <div className="flex items-center justify-end gap-2 mb-2">
                                    ...
                                    >
                                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M16.5 9V19H8.5V9H16.5ZM15 3H10L9 4H5.5V6H19.5V4H16L15 3ZM18.5 7H6.5V19C6.5 20.1 7.4 21 8.5 21H16.5C17.6 21 18.5 20.1 18.5 19V7Z" fill="#FF3A3A" />
                                        </svg>
                                ...
                                <div>
                                    <label className="block text-[#2C2C2C] text-sm font-bold my-2">Item Name</label>
                                    <input
                                        type="text"
                                        placeholder="Enter Name"
                                        value={item.name}
                                ...
                                <div>
                                    <label className="block text-[#2C2C2C] text-sm font-bold my-2">Item Description</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="block text-[#2C2C2C] text-sm font-bold my-2">Item Price</label>
                                    <input
                                        type="text"
