...
interface EditVenueProps {
    venue: IVenueTable;
    onClose: () => void;
    onSave: (updatedVenue: IVenueTable) => void;
}

const EditVenue: React.FC<EditVenueProps> = ({ venue, onClose, onSave }) => {
    // Initialize form data with venue data
    const [formData, setFormData] = useState<FormData>({
        restaurantName: venue["Venue Name"],
        description: venue["Venue Type"],
    ...
    // Initialize with just one menu item
    ...
    const handleSave = () => {
        ...
        const updatedVenue: IVenueTable = {
            ...venue,
            "Venue Name": formData.restaurantName,
            "Venue Type": formData.description,
            ...
            <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto relative">
                <div className="p-6">
                    <div className="flex justify-between items-center mb-4">
                        <h1 className="text-2xl font-extrabold">Edit Venue</h1>
                        <button
                            onClick={onClose}
